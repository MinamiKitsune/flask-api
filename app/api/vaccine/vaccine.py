...
vaccine_put_args.add_argument("target_disease", type=str, required=True,
                              help="The name of the target disease that the vaccine is made for is "
                                   "required in String format.")
vaccine_put_args.add_argument("number_to_administer", type=int, required=True,
                              help="The number of doses the vaccine requires is required in Int format.")
...
vaccine_get_args.add_argument("target_disease", type=str,
                              help="The name of the target disease that the vaccine is made for "
...
vaccine_patch_args.add_argument("number_to_administer", type=int,
                                help="The number of doses the vaccine requires needs to be in Int format.")
vaccine_patch_args.add_argument("dosage_interval", type=int,
                                help="The number of days that need to elapse before the next dose is administered "
                                     "needs to be in Int format.")
...
def add_vaccine(args):
    new_vaccine = Vaccine(vaccine_name=args["vaccine_name"], target_disease=args["target_disease"],
                          number_to_administer=args["number_to_administer"],
